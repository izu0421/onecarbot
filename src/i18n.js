...
const en = {
  ...
  'auth.no_password': 'No password needed — we email you a code each time.',
  'auth.code_h1': 'Check your email',
  'auth.code_sub': 'We sent a six-digit code to {email}. It expires in 10 minutes.',
  'auth.verify': 'Sign in',
  'auth.resend': 'Send another code',
  'auth.resend_in': 'Send another code in {n}s',
...
const zh = {
  ...
  'auth.no_password': '无需密码 —— 每次登录我们都会向您发送验证码。',
  'auth.code_h1': '请查收邮件',
  'auth.code_sub': '我们已向 {email} 发送六位验证码，10 分钟内有效。',
  'auth.verify': '登录',
  'auth.resend': '重新发送验证码',
  'auth.resend_in': '{n} 秒后可重新发送',
  'auth.change_email': '更换邮箱',
  'err.save': '保存失败：',
